...
![image-20210602095223123](.images/image-20210602095223123.png)
...
![image-20210602100430520](.images/image-20210602100430520.png)
...
```shell
# 创建文件夹
[root@node01]> mkdir ingress-controller
[root@node01]> cd ingress-controller/
...
# 查看ingress-nginx
[root@node01]> kubectl get pod -n ingress-nginx
...
![image-20210602101117439](.images/image-20210602101117439.png)
...
# 查看
[root@node01]> kubectl get svc -n dev
NAME             TYPE        CLUSTER-IP   EXTERNAL-IP   PORT(S)    AGE
